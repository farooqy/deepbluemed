                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6 list-inline list-unstyled no-margin hidden-xs">
                                <p class="no-margin">Have any questions? <strong>+080 124 880</strong> or mail@pamukovic.com</p>
                            </div>
                ...
                <div class="container middle-bar hidden-xs">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-sm-offset-1 contact-info">
                            <p>Have any questions? <span>+114 554 888</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="fullsize-slider">
                    <ul>
                        <li data-transition="fade" data-slotamount="1" data-thumb="http://placehold.it/200x200" data-delay="7500" data-saveperformance="off" data-title="Our Workplace">
                            <!-- MAIN IMAGE -->
                            <img src="http://placehold.it/1920x1080" data-bgfit="cover" data-bgrepeat="no-repeat" alt="">
                            <!-- LAYERS -->
                        ...
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="http://placehold.it/200x200" data-delay="7000" data-saveperformance="off" data-title="Slide">
                            <!-- MAIN IMAGE -->
                            <img src="http://placehold.it/1920x1080" alt="fullslide6" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                            <!-- LAYERS -->
